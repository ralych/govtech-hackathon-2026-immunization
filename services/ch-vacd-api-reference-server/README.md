...
It is setup as a spring-boot service with resource providers (HAPI FHIR) to serve the resources as they will be useful in the context of the immunization.
