 ...
 * runtime via the `EXAMPLES_DIR` env var. The PBLL refuses to start if
...
class Examples(private val dir: Path) {
    ...
    companion object {
         ...
         * fallback to the repo-relative path (works when the PBLL is run from
        ...
        fun fromEnvOrDevDefault(envVar: String = "EXAMPLES_DIR"): Examples {
            ...
            val candidates = buildList {
                ...
                add(Path.of("../../examples"))  // run from services/pbll/
